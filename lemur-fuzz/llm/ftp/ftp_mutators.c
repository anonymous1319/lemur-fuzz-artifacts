...
int mutate_user_username(ftp_user_packet_t *pkt, uint32_t seed, int op) {
    ...
    /* ===== D. Allowed bitfield / enum / range: n/a for free-form username ===== */
...
int mutate_pass_password(ftp_pass_packet_t *pkt, uint32_t seed, int op) {
    ...
    switch (chosen_case) {
        ...
        /* ===== D. Allowed bitfield / enum / range: n/a for free-form password ===== */
        /* ===== E. Encoding-validity preservation ===== */
...
int mutate_acct_account_info(ftp_acct_packet_t *pkt, uint32_t seed, int op){
    ...
    switch (chosen_case) {
        ...
        /* ===== D. Allowed bitfield / enum / range: n/a for free-form account ===== */
        /* ===== E. Encoding-validity preservation ===== */
...
int mutate_cwd_pathname(ftp_cwd_packet_t *pkt, uint32_t seed, int op){
    ...
    switch (chosen_case) {
        ...
        /* ===== D. Allowed bitfield / enum / range: n/a for free-form pathname ===== */
        /* ===== E. Encoding-validity preservation ===== */
...
int mutate_port_host_port_str(ftp_port_packet_t *pkt, uint32_t seed, int op){
    ...
    switch (chosen_case) {
        ...
        /* ===== D. Allowed bitfield / enum / range: n/a for free-form host-port string ===== */
        /* ===== E. Encoding-validity preservation ===== */
        ...
        /* ===== F. Padding / alignment: n/a for fixed-format comma list ===== */
        /* ===== G. Prefix / suffix variants: n/a for numeric host-port tuple ===== */
        /* ===== H. Random valid mix ===== */
...
int mutate_type_type_code(ftp_type_packet_t *pkt, uint32_t seed, int op){
    ...
    switch (chosen_case) {
        ...
        /* ===== B. Boundary values: n/a for enum type code ===== */
        /* ===== C. Equivalence-class alternatives ===== */
        ...
        /* ===== E. Encoding-validity preservation: n/a for enum type code ===== */
        /* ===== F. Padding / alignment: n/a for enum type code ===== */
        /* ===== G. Prefix / suffix variants: n/a for enum type code ===== */
        /* ===== H. Random valid mix: n/a for enum type code ===== */
        default:
            return 0;
    }
...
int mutate_type_format_control(ftp_type_packet_t *pkt, uint32_t seed, int op){
    ...
    switch (chosen_case) {
        ...
        /* ===== B. Boundary values: n/a for enum format control ===== */
        /* ===== C. Equivalence-class alternatives ===== */
        ...
        /* ===== E. Encoding-validity preservation: n/a for enum format control ===== */
        /* ===== F. Padding / alignment: n/a for enum format control ===== */
        /* ===== G. Prefix / suffix variants: n/a for enum format control ===== */
        /* ===== H. Random valid mix: n/a for enum format control ===== */
        default:
            return 0;
    }
    return 1;
...
int mutate_stru_structure_code(ftp_stru_packet_t *pkt, uint32_t seed, int op){
    ...
    switch (chosen_case) {
        ...
        case 0:  /* "F" */
            ...
            break;
        /* ===== B. Boundary values: n/a for enum structure code ===== */
        /* ===== C. Equivalence-class alternatives ===== */
        case 1:  /* "R" */
        ...
        case 2:  /* "P" */
            ...
            break;
        /* ===== D. Allowed bitfield / enum / range ===== */
        /* (F, R, P are the full enum set — no extra members) */
        /* ===== E. Encoding-validity preservation: n/a for enum structure code ===== */
        /* ===== F. Padding / alignment: n/a for enum structure code ===== */
        /* ===== G. Prefix / suffix variants: n/a for enum structure code ===== */
        /* ===== H. Random valid mix ===== */
        case 14: {
            const char *ok[] = {"F", "R", "P"};
...
int mutate_mode_mode_code(ftp_mode_packet_t *pkt, uint32_t seed, int op){
    ...
    switch (chosen_case) {
        ...
        case 0:  /* "S" */
            ...
            break;
        /* ===== B. Boundary values: n/a for enum mode code ===== */
        /* ===== C. Equivalence-class alternatives ===== */
        case 1:  /* "B" */
        ...
        case 2:  /* "C" */
            ...
            break;
        /* ===== D. Allowed bitfield / enum / range ===== */
        /* (S, B, C are the full enum set — no extra members) */
        /* ===== E. Encoding-validity preservation: n/a for enum mode code ===== */
        /* ===== F. Padding / alignment: n/a for enum mode code ===== */
        /* ===== G. Prefix / suffix variants: n/a for enum mode code ===== */
        /* ===== H. Random valid mix ===== */
        case 14: {
            const char *ok[] = {"S","B","C"};
...
int mutate_retr_pathname(ftp_retr_packet_t *pkt, uint32_t seed, int op){
    ...
    switch (chosen_case) {
        ...
        case 7:
            ...
            break;                       /* trailing slash (min path-like) */
        case 8: {
        ...
        case 16:
            ...
            break;                         /* device-name escape kept legal */

        /* ===== F. Padding / alignment ===== */
        case 20:
            buf_set(pkt->pathname, sizeof(pkt->pathname),
                    "  spaced-leading-and-trailing  ");
            break;                          /* whitespace padding */

        /* ===== G. Prefix / suffix variants ===== */
        /* (leading-dot / trailing-slash variants already covered by cases 4/7) */
...
int mutate_stou_pathname(ftp_stou_packet_t *pkt, uint32_t seed, int op){
    ...
    switch (chosen_case) {
        ...
        /* ===== B. Boundary values ===== */
        case 0:
            return delete_stou_pathname(pkt);   /* empty/minimal */
        case 9:
            pkt->space[0] = ' '; pkt->space[1] = '\0';
            buf_set(pkt->pathname, sizeof(pkt->pathname), "a");
            break;                       /* single char */
        ...
        case 13:
            ...
            buf_set(pkt->pathname, sizeof(pkt->pathname),
                    " name with spaces .txt");
            break;                          /* leading whitespace padding */
...
int mutate_appe_pathname(ftp_appe_packet_t *pkt, uint32_t seed, int op){
    ...
    switch (chosen_case) {
        ...
        case 28:
            buf_set(pkt->pathname, sizeof(pkt->pathname),
                    "  file . log  ");
            break;                          /* whitespace padding both ends */
...
int mutate_allo_byte_count(ftp_allo_packet_t *pkt, uint32_t seed, int op){
    ...
    switch (chosen_case) {
        ...
        case 27:
            ...
            break; /* very big decimal */

        /* ===== C. Equivalence-class alternatives: n/a for numeric byte count ===== */
        ...
        /* ===== E. Encoding-validity preservation: n/a for numeric byte count ===== */
        ...
        case 19: {
            ...
            break;                        /* fill-to-capacity with '9' */
        }

        /* ===== G. Prefix / suffix variants: n/a for numeric byte count ===== */
        ...
        case 22: {
            ...
            break;                        /* random decimal digit string */
        }
...
int mutate_allo_record_format(ftp_allo_packet_t *pkt){
    ...
    switch (op){
        ...
        /* ===== C. Equivalence-class alternatives: n/a for fixed "R <n>" form ===== */

        /* ===== D. Allowed bitfield / enum / range ===== */
        case 6:
            set_space(pkt->space2, 1);
            set_cstr(pkt->record_format, sizeof(pkt->record_format), "R 00064");
            break;                       /* leading-zero decimal */

        /* ===== E. Encoding-validity preservation: n/a for numeric record size ===== */
        ...
        /* ===== G. Prefix / suffix variants: n/a for fixed "R <n>" form ===== */

        /* ===== H. Random valid mix: n/a for fixed "R <n>" form ===== */
...
int mutate_rest_marker(ftp_rest_packet_t *pkt){
    ...
    switch(op){
        ...
        case 18:
            ...
            break;                       /* over uint64_max */

        /* ===== C. Equivalence-class alternatives: n/a for numeric marker ===== */
        ...
        /* ===== E. Encoding-validity preservation: n/a for numeric marker ===== */
        ...
        /* ===== G. Prefix / suffix variants: n/a for numeric marker ===== */

        /* ===== H. Random valid mix: n/a for numeric marker ===== */
...
int mutate_rnfr_pathname(ftp_rnfr_packet_t *pkt){
    ...
    switch(op){
        ...
        case 12:
            ...
            set_cstr(pkt->pathname, sizeof(pkt->pathname),
                     "a b/ c.txt");
            break;                       /* embedded whitespace padding */
        case 22: {
            set_space(pkt->space,1);
            const char *seg = "../";
            size_t cap = sizeof(pkt->pathname);
        ...
        case 15:
            ...
            break;                       /* percent-encoded prefix */
        case 16:
            set_space(pkt->space,1);
            set_cstr(pkt->pathname, sizeof(pkt->pathname),
                     "%252e%252e%252fetc%252fpasswd");
            break;                       /* double-encoded prefix */
...
int mutate_rnto_pathname(ftp_rnto_packet_t *pkt){
    ...
    switch(op){
        ...
        case 17:
            ...
            break;                       /* leading dot prefix */
        case 20:
            set_space(pkt->space,1);
            set_cstr(pkt->pathname, sizeof(pkt->pathname),
                     "trailingdot.");
            break;                       /* trailing dot suffix */
        case 21:
            set_space(pkt->space,1);
            set_cstr(pkt->pathname, sizeof(pkt->pathname),
                     "new%20name.txt");
...
int mutate_rmd_pathname(ftp_rmd_packet_t *pkt){
    ...
    switch(op){
        ...
        case 12: set_space(pkt->space,1); set_cstr(pkt->pathname, sizeof(pkt->pathname), "/"); break;  /* root (min) */
        case 28: {
            set_space(pkt->space,1);
            size_t cap = sizeof(pkt->pathname);
            if (cap > 1){
...
int mutate_mkd_pathname(ftp_mkd_packet_t *pkt){
    ...
    switch(op){
        ...
        case 29: {
            ...
            pkt->pathname[len] = '\0';
            break;                       /* fill-to-capacity with /a pattern */
        }
...
int mutate_nlst_pathname(ftp_nlst_packet_t *pkt){
    ...
    switch(op){
        ...
        case 26: {
            ...
            pkt->pathname[len] = '\0';
            break;                       /* fill-to-capacity with /n pattern */
        }
...
int mutate_site_parameters(ftp_site_packet_t *pkt){
    ...
    switch (op){
        ...
        /* ===== D. Allowed bitfield / enum / range: n/a for free-form parameter string ===== */
...
int mutate_stat_pathname(ftp_stat_packet_t *pkt){
    ...
    switch (op){
        ...
        case 14: set_space(pkt->space,1); set_cstr(pkt->pathname,sizeof(pkt->pathname),
                                                  "/数据/文件.txt"); break; /* valid UTF-8 */
        case 15: set_space(pkt->space,1); set_cstr(pkt->pathname,sizeof(pkt->pathname),
                                                  "/tmp/😀.txt"); break;     /* valid UTF-8 rare */
        case 18:
            set_space(pkt->space,1);
            set_cstr(pkt->pathname,sizeof(pkt->pathname),
                     "path_^M^J_ANOTHER");
        ...
        case 17: {
            ...
            break;                       /* fill-to-capacity with deep/ pattern */
        }
        case 25:
            set_space(pkt->space,1);
            set_cstr(pkt->pathname,sizeof(pkt->pathname),
...
int mutate_help_argument(ftp_help_packet_t *pkt){
    ...
    switch (op){
        ...
        /* ===== B. Boundary values ===== */
        case 3:  set_space(pkt->space,1); set_cstr(pkt->argument,sizeof(pkt->argument), "abor"); break;  /* lowercase */
        case 4:  set_space(pkt->space,1); set_cstr(pkt->argument,sizeof(pkt->argument), "FOO"); break;    /* unknown cmd */
        ...
        case 22: set_space(pkt->space,0); set_cstr(pkt->argument,sizeof(pkt->argument), "USER"); break;    /* no space */
        case 23: set_space(pkt->space,1); set_cstr(pkt->argument,sizeof(pkt->argument), ""); break;          /* empty */
        ...
        /* ===== D. Allowed bitfield / enum / range: n/a for free-form argument ===== */
